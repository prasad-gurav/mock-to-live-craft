...
const HeroSection = () => {
	return (
		<section
			className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black/40 to-muted/30"
			style={{
					...
					<div className="space-y-8">
						<div className="space-y-6">
							<h1 className="text-5xl lg:text-7xl font-bold text-foreground leading-tight">
								Connecting the{" "}
								<span className="relative flex items-center gap-x-4">
									<span className="bg-gradient-to-r from-primary to-blue-500 bg-clip-text text-transparent">
										Dots
									</span>
									<div className=" left-0 flex space-x-1">
					...
					<div className="relative">
						...
						<Card className="absolute top-0 right-0 p-6 bg-card/80 backdrop-blur-sm border shadow-lg w-48 z-20">
							<div className="text-center">
								...
								<div className="text-sm text-muted-foreground">
									Active IT companies that
								</div>
								<div className="text-sm text-muted-foreground">
									we work with individual or
								</div>
								<div className="text-sm text-muted-foreground">
									group of employees
								</div>
							...
							<div className="text-center">
								...
								<div className="flex justify-center mt-2">
									<div className="flex -space-x-2">
										...
										<div className="w-6 h-6 bg-background/20 rounded-full border border-primary-foreground"></div>
										<div className="w-6 h-6 bg-background/20 rounded-full border border-primary-foreground"></div>
										<div className="w-6 h-6 bg-background/20 rounded-full border border-primary-foreground flex items-center justify-center text-xs">
											+
										</div>
									</div>
								</div>
